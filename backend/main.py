...
from app.api import chat, admin, auth, documents, chunks, ai
from app.api import import_api, elasticsearch_api
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "*"  # Разрешаем все источники для работы через nginx прокси
    ],
