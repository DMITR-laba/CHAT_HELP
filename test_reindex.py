...
def test_reindex():
    ...
    for i in range(0, min(30, len(articles)), batch_size):
        ...
        # Проверяем, что все эмбеддинги имеют правильную размерность
        valid_embeddings = []
        ...
        print(f'Processed {processed}/{min(30, len(articles))} articles')
